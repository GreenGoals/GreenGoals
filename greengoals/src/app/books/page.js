...
const BooksPage = () => {
  ...
  const schools = ['School A', 'School B', 'School C', 'School D']; // Add your list of schools here
  ...
  const handleExchangeSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // Handle success - Optionally show a success message
        Swal.fire({
            title: 'Success!',
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Available Books for Exchange</h1>
      ...
      {filteredBooks.length === 0 ? (
        <p className="text-center text-xl">No books available at the moment.</p>
      ) : (
          ...
          {filteredBooks.map((book) => (
            <div key={book._id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 mb-1">Owner: {book.author}</p>
                ...
                <button
                  ...
                  className="w-full bg-[#A0937D] text-white py-2 px-4 rounded hover:bg-[#B6C7AA] transition duration-300"
                >
                  Exchange
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
          <div className="bg-white rounded-lg p-8 max-w-md w-full">
            ...
            <form onSubmit={handleExchangeSubmit}>
              <div className="mb-4">
                <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="userBook">
                  Your Book Title
                </label>
                <input
                  type="text"
